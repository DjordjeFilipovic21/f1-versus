...
export class JeddahState implements CircuitState {
  @ViewChild('circuitContainer', { static: true }) circuitContainer!: ElementRef;
  private circuitGeoJson: any = 'https://raw.githubusercontent.com/bacinger/f1-circuits/refs/heads/master/circuits/sa-2021.geojson';
  ...
  fetchSessionData(circuitId: number): void {
    console.log('Fetching session data for Jeddah...');
  }
