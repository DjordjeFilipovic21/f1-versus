...
export class SakhirState implements CircuitState {
  @ViewChild('circuitContainer', { static: true }) circuitContainer!: ElementRef;
  private circuitGeoJson: any = 'https://raw.githubusercontent.com/bacinger/f1-circuits/refs/heads/master/circuits/bh-2002.geojson';
  ...
  fetchSessionData(circuitId: number): void {
    console.log('Fetching session data for Sakhir...');
  }
