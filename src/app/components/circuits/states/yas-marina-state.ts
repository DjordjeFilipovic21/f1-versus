...
export class YasMarinaState implements CircuitState {
  @ViewChild('circuitContainer', { static: true }) circuitContainer!: ElementRef;
  private circuitGeoJson: any = 'https://raw.githubusercontent.com/bacinger/f1-circuits/refs/heads/master/circuits/ae-2009.geojson';
  ...
  fetchSessionData(circuitId: number): void {
    console.log('Fetching session data for Yas Marina...');
  }
